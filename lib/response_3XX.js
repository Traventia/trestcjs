...
exports.process = function(response,options,httpResponse,trace,callback){
    ...
    if (typeof httpResponse.headers['location'] == 'undefined' && typeof httpResponse.headers['Location'] == 'undefined'){
        ...
        return rerr.process(errors.REDIRECTION_WITHOUT_LOCATION,httpResponse.statusCode,trace,callback)
    }
    ...
    if (newDestination == null){
        ...
        return rerr.process(errors.REDIRECTION_UNPARSEABLE,httpResponse.statusCode,trace,callback)
    }
