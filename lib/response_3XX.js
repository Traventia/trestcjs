...
exports.process = function(response,options,httpResponse,reqLogObject,callback){
    ...
    if (typeof httpResponse.headers['location'] == 'undefined' && typeof httpResponse.headers['Location'] == 'undefined'){
        ...
        return rerr.process(errors.REDIRECTION_WITHOUT_LOCATION,response,options,httpResponse,reqLogObject,callback)
    }
    ...
    if (newDestination == null){
        ...
        return rerr.process(errors.REDIRECTION_UNPARSEABLE,response,options,httpResponse,reqLogObject,callback)
    }

    //return to request
    return callback(null,null,newDestination);
};
