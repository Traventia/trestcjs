        ...
        if(typeof res.headers['content-encoding'] !== 'undefined'){
            if (res.headers['content-encoding'] == 'gzip'){
                ...
                return zlib.gunzip(buffer,function(gziperr,decoded){
                    if (gziperr != null){
                        return rerr.process(errors.ERROR_GZIP_PARSING_RESPONSE,buffer,res,reqLogObject,callback)
                    }
...
var _httpCodeStatusResponseDecode = function(response,options,httpResponse,reqLogObject,callback){
    switch (httpResponse.statusCode){
        ...
        case 302:
            ...
            break;
        default:
            rerr.process(errors.ERROR_STATUS_CODE,response,httpResponse,reqLogObject,callback)
            break;
    }
};
