 ...
 */
exports.http = function(method,host,port,path,options,data,pathparams,callback){
	//Check method exists
...
exports.https = function(method,host,port,path,options,data,pathparams,callback){
	//Check method exists
	if (_IMPLEMENTED_HTTP_METHODS_.indexOf(method)<0){
		return callback({err:'TODO'});
	}
