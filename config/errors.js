...
module.exports = Object.freeze({
	...
	ERROR_STATUS_CODE               : {code:10,msg:'Status code of response indicate an error'},
	...
	ERROR_PARSING_RESPONSE          : {code:17,msg:'Received configuration for parsing response but response doesnt exists'},
});
